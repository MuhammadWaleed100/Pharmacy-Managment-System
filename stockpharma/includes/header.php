...
<div id="pic"><a href="#"><img src="logo.png"></a></div><div id="main">  Servaid Pharmacy Management System</div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li id="navBrand"><a href="brand.php"><i class="glyphicon glyphicon-btc"></i>Supplier</a></li>        

        <li id="navCategories"><a href="categories.php"> <i class="glyphicon glyphicon-th-list"></i> Product Category</a></li>        
        ...
        <li class="dropdown" id="navOrder">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddOrder"><a href="orders.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Add Sales</a></li>            
